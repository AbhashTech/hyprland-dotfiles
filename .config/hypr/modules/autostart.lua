...
hl.on("hyprland.start", function ()
    ...
    hl.exec_cmd("python3 " .. os.getenv("HOME") .. "/.config/hypr/scripts/sunset_idle_manager.py --daemon &")
    ...
    hl.exec_cmd("systemctl --user import-environment WAYLAND_DISPLAY XDG_CURRENT_DESKTOP QT_QPA_PLATFORMTHEME 2>/dev/null || true")
