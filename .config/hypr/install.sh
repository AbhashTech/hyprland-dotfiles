...
for desktop_file in app-shortcut-creator.desktop theme-manager.desktop ocr-language-manager.desktop hyprsunset-hypridle.desktop plugin-manager.desktop keyboard-layout-manager.desktop dotpersonal-manager.desktop keybind-manager.desktop; do
