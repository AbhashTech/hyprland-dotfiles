...
for desktop_file in app-shortcut-creator.desktop theme-manager.desktop ocr-language-manager.desktop hyprsunset-hypridle.desktop plugin-manager.desktop; do
